# Data Analysis Project using SQL & Oracle Database
# Marc Pierre-Louis
# June 2020

𝗔𝗜𝗠:  
In this SQL Project for Data Analysis, I will leverage various analytical features and functions accessible through SQL in Oracle DB.

𝗪𝗵𝗮𝘁 𝗶𝘀 𝘁𝗵𝗲 𝗔𝗴𝗲𝗻𝗱𝗮 𝗼𝗳 𝘁𝗵𝗲 𝗽𝗿𝗼𝗷𝗲𝗰𝘁?  
The project’s Agenda involves Analyzing the data using SQL on the Oracle Database Software. I will first download the Oracle Database from the Oracle website and understand the problem. Then tables are created in the database followed by data insertion into tables and exploration, i.e., noticing relationships between tables, walking through the columns, and seeing comments. And perform the following activties--  
...
7. understanding of the Online Shopping Database

Using this database to perform the following Data Wrangling activities -->
...
𝗞𝗲𝘆 𝗧𝗮𝗸𝗲𝗮𝘄𝗮𝘆𝘀:  
● Understanding the project and how to use Oracle Database.                                                                                                         
